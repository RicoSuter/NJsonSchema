...
**NuGet packages:** 
-   [NJsonSchema](https://www.nuget.org/packages/NJsonSchema) (.NET Standard 1.0 and .NET 4.0): JSON Schema 4 validation and parsing classes
...
- Generate JSON Schema from sample JSON data (`JsonSchema.FromData()`)
