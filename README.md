...
The NuGet packages may require the "Microsoft.NETCore.Portable.Compatibility" package on .NET Core/UWP targets. The library uses [Json.NET](http://james.newtonking.com/json) to read and write JSON data. 
