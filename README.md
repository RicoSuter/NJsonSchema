...
- [Generate JSON Schema from .NET type via reflection](https://github.com/RicoSuter/NJsonSchema/wiki/JsonSchemaGenerator) (with support for many attributes/annotations) (`NewtonsoftJsonSchemaGenerator.FromType<MyType>()`)
