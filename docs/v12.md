...
Items landed on `v12` (update when PRs merge):

- 2026-04-21 — Set up `v12` integration branch and CI (this PR).

Planned (not yet merged):

- STJ core migration — PR #1914
- JsonTypeInfo-based property discovery — PR #1917
