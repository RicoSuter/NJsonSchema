...
namespace NJsonSchema.CodeGeneration.CSharp.Tests
{
    public class GeneralGeneratorTests
    {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<Teacher>();
...
@"{
	...
	'properties': {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<Person>();
        ...
        {
            // Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<File>();
            var generator = new CSharpGenerator(schema);
        ...
        public async Task When_property_is_object_then_any_type_is_generated()
        {
            ...
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<ObjectTestClass>();
...
@"{
  ""$schema"": ""http://json-schema.org/draft-04/schema#""
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<ClassWithDefaultEnumProperty>();
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<ClassWithDefaultEnumProperty>(new JsonSchemaGeneratorSettings { DefaultEnumHandling = EnumHandling.String });
            var schemaJson = schema.ToJson();
  ...
  ""properties"": {
    ""Foo"": {
      ""type"": ""string""
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<Person2>();
            var schemaJson = schema.ToJson();
...
@"{
	...
	""definitions"": {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<ObsClass>();
            var settings = new CSharpGeneratorSettings();
            var generator = new CSharpGenerator(schema, settings);
...
@"{
	...
	""properties"": {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<MyByteTest>();
            var json = schema.ToJson();
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<MyRequiredNullableTest>();
            var json = schema.ToJson();
...
@"{
	...
	""properties"": {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<Address>();
            var data = schema.ToJson();
            var generator = new CSharpGenerator(schema, new CSharpGeneratorSettings
            {
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<AbstractAddress>();
            var data = schema.ToJson();
            var generator = new CSharpGenerator(schema, new CSharpGeneratorSettings
            {
                ClassStyle = CSharpClassStyle.Record
        ...
        {
            //// Arrange
            var schema = await JsonSchemaGenerator.FromTypeAsync<PersonAddress>();
            var data = schema.ToJson();
            var generator = new CSharpGenerator(schema, new CSharpGeneratorSettings
            {
                ClassStyle = CSharpClassStyle.Record
