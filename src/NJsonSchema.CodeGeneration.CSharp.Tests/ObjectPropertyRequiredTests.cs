...
namespace NJsonSchema.CodeGeneration.Tests.CSharp
{
    public class ObjectPropertyRequiredTests
    {
        ...
        {
            //// Arrange
            var schema = JsonSchemaGenerator.FromType<ClassWithRequiredObject>();
            var schemaData = schema.ToJson();
        ...
        {
            //// Arrange
            var schema = JsonSchemaGenerator.FromType<ClassWithoutRequiredObject>(new NewtonsoftJsonSchemaGeneratorSettings
            {
                SchemaType = SchemaType.Swagger2
            });
            var schemaData = schema.ToJson();
        ...
        {
            //// Arrange
            var schema = JsonSchemaGenerator.FromType<ClassWithoutRequiredObject>();
            var schemaData = schema.ToJson();
