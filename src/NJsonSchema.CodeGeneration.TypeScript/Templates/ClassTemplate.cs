...
if(Model.GenerateConstructorInterface){
		...
		foreach(var property in Model.Properties){
			...
			if(property.Type != property.TypeForInterface) {
            ...
            #line default
            #line hidden
            this.Write("[i] = source && !(source instanceof ");
            
            #line 37 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(property.Type.Replace("[]","")));
            ...
            #line default
            #line hidden
            this.Write("\t\t//TODO: Dictionary needs special handling for ");
...
if(Model.HandleReferences){
  ...
  if(Model.HasBaseDiscriminator){
      ...
      foreach (var derivedClass in Model.DerivedClasses){
            ...
            #line 100 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
if(Model.HasIndexerProperty){
            ...
            #line 106 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
if(Model.HasDiscriminator){
            ...
            #line 108 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
}
...
foreach (var property in Model.Properties){
            ...
            #line 110 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
...
if(Model.GenerateCloneMethod){
            ...
            #line 127 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
if(Model.GenerateConstructorInterface){
            ...
            #line 129 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
  if(Model.HasDescription){
            ...
            #line 130 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Model.Description));
            ...
            #line 131 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
  }
            ...
            #line 133 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
  foreach(var property in Model.Properties){
      ...
      if(property.HasDescription){
            ...
            #line 135 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(property.Description));
...
if(property.IsOptional){
            ...
            #line 137 "C:\Data\Projects\NJsonSchema\src\NJsonSchema.CodeGeneration.TypeScript\Templates\ClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(property.TypeForInterface));
