...
namespace NJsonSchema.Tests.Conversion
{
    public class TypeToSchemaTests
    {
        ...
        {
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<ClassWithRegexDictionaryProperty>();
        ...
        {
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<MyType>(new JsonSchemaGeneratorSettings
            {
        ...
        {
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<ClassWithJObjectProperty>();
