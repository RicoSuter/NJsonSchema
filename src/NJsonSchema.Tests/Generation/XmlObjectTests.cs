...
namespace NJsonSchema.Tests.Generation
{
    public class XmlObjectTests
    {
        ...
        {
            var schema = JsonSchemaGenerator.FromType<WithoutXmlAttributesDefined>(new JsonSchemaGeneratorSettings() { GenerateXmlObjects = true });
        ...
        private void AssertTypeWithoutXmlAttributes(JsonSchema schema)
        {
        ...
        {
            var schema = JsonSchemaGenerator.FromType<WithXmlAttributesDefined>(new JsonSchemaGeneratorSettings
            {
        ...
        private void AssertTypeWithXmlAttributes(JsonSchema schema, JsonSchema rootDefinitionSchema)
        {
        ...
        {
            var schema = JsonSchemaGenerator.FromType<WithXmlIncorrectAttributesDefined>(new JsonSchemaGeneratorSettings
            {
                GenerateXmlObjects = true
            });
