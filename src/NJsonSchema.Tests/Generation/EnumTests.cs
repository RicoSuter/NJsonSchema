...
namespace NJsonSchema.Tests.Generation
{
    public class EnumTests
    {
        ...
        public async Task When_enum_is_used_multiple_times_in_array_then_it_is_always_referenced()
        {
            ...
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<MyController>(new JsonSchemaGeneratorSettings
            {
        ...
        public async Task When_property_is_dictionary_with_enum_value_then_it_is_referenced()
        {
            ...
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<ContainerWithEnumDictionary>(new JsonSchemaGeneratorSettings
            {
                DefaultEnumHandling = EnumHandling.Integer
            });
            var json = schema.ToJson();
        ...
        public async Task When_SerializerSettings_has_CamelCase_StringEnumConverter_then_enum_values_are_correct()
        {
            ...
            // Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<MyEnum>(settings);
            var json = schema.ToJson();
        ...
        public async Task When_enum_has_FlagsAttribute_then_custom_property_is_set()
        {
            ...
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<EnumWithFlags>(new JsonSchemaGeneratorSettings
            {
        ...
        public async Task When_enum_does_not_have_FlagsAttribute_then_custom_property_is_not_set()
        {
            ...
            //// Act
            var schema = await JsonSchemaGenerator.FromTypeAsync<EnumWithoutFlags>(new JsonSchemaGeneratorSettings
            {
                DefaultEnumHandling = EnumHandling.String
            });
            var json = schema.ToJson();
